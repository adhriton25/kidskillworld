  ...
  if (status === "success") {
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <div className="bg-white w-full max-w-md rounded-[2.5rem] shadow-xl p-12 text-center border border-slate-100">
      ...
      <div className="bg-white w-full max-w-md rounded-[2.5rem] shadow-xl p-8 md:p-12 border border-slate-100">
        ...
        {!token ? (
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            {status === "error" && (
              <p className="text-red-500 text-center text-sm">Failed to update. Link may be expired.</p>
            )}
          </form>
        )}
      </div>
